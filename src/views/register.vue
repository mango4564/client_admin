			...
			<el-row>
				<el-col>
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<!-- 宿管人员 -->
						<form_housekeeping_personnel v-if="form.user_group === '宿管人员'" :form="form_sub" ></form_housekeeping_personnel>
...
<script>
	...
	/* 宿管人员 */
	import form_housekeeping_personnel from "@/components/diy/form_housekeeping_personnel";
